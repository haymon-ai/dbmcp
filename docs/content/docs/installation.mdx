...
```bash
curl -LO https://github.com/haymon-ai/database-mcp/releases/latest/download/database-mcp-x86_64-unknown-linux-gnu.tar.gz
...
```bash
curl -LO https://github.com/haymon-ai/database-mcp/releases/latest/download/database-mcp-aarch64-unknown-linux-gnu.tar.gz
...
```bash
curl -LO https://github.com/haymon-ai/database-mcp/releases/latest/download/database-mcp-aarch64-apple-darwin.tar.gz
